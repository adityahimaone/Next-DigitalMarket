  ...
  return (
    <MaxWidthWrapper className="bg-white">
      <div className="bg-white">
        <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-16 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
          {/* Product Details */}
          <div className="lg:max-w-lg lg:self-end">
            ...
            {/* add to cart part */}
            <div className="mt-10 lg:col-start-1 lg:row-start-1 lg:max-w-lg lg:self-center">
              <div>
                <div className="mt-10">
                  <AddToCartButton />
                </div>
