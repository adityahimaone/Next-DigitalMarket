...
const Page = async ({ searchParams }: Props) => {
  ...
  return (
    <main className="relative lg:min-h-full">
      ...
      <div>
        <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:grid lg:grid-cols-2 lg:max-w-7xl lg:gap-x-8 lg:px-8 lg:py-32 xl:gap-x-24">
          <div className="lg:col-start-2">
            ...
            {order._isPaid ? (
              <p className="mt-2 text-base text-muted-foreground">
                ...
                available to download bellow. We&apos;ve sent your receipt and
                orders detail to{" "}
              ...
              <p className="mt-2 text-muted-foreground text-base">
                ...
                hang tight and we&apos;ll send your confirmation very soon!
              </p>
            )}
            ...
            <div className="space-y-1 border-t border-gray-200 pt-6 text-md text-muted-foreground">
